...
lemma TT3w_init_event:
  "TT3w P \<Longrightarrow> TT3w {t. [e]\<^sub>E # t \<in> P}"
  unfolding TT3w_def by (safe, force)
...
lemma TT3w_TT1_init_tock:
  "TT3w P \<Longrightarrow> TT1 P \<Longrightarrow> TT3w {t. [X]\<^sub>R # [Tock]\<^sub>E # t \<in> P}"
  unfolding TT3w_def
proof (safe)
  fix \<rho>
...
lemma TT3w_ParComp:
  ...
  shows "TT3w (P \<lbrakk>A\<rbrakk>\<^sub>C Q)"
  unfolding ParCompTT_def TT3w_def using assms
proof auto
  fix \<rho>
  show "\<And> p q P Q. TT1 P \<Longrightarrow> TT1 Q \<Longrightarrow> TT3w P \<Longrightarrow> TT3w Q \<Longrightarrow> \<rho> \<in> p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q \<Longrightarrow> p \<in> P \<Longrightarrow> q \<in> Q \<Longrightarrow>
    \<exists>x. (\<exists>p\<in>P. \<exists>q\<in>Q. x = p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q) \<and> add_Tick_refusal_trace \<rho> \<in> x"
  proof (induct \<rho> rule:ttWF.induct, auto)
    fix X p q P Q
    assume case_assms: "[[X]\<^sub>R] \<in> p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q" "p \<in> P" "q \<in> Q" "TT3w P" "TT3w Q"
    ...
    proof safe
      ...
      then have "[[Y \<union> {Tick}]\<^sub>R] \<in> P" "[[Z \<union> {Tick}]\<^sub>R] \<in> Q"
        using TT3w_def case_assms by force+
      then show "\<exists>x. (\<exists>p\<in>P. \<exists>q\<in>Q. x = p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q) \<and> [[insert Tick X]\<^sub>R] \<in> x"
  ...
  next
    fix e \<sigma> p q P Q
    assume ind_hyp: "\<And>p q P Q. TT1 P \<Longrightarrow> TT1 Q \<Longrightarrow> TT3w P \<Longrightarrow> TT3w Q \<Longrightarrow> \<sigma> \<in> p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q \<Longrightarrow> p \<in> P \<Longrightarrow> q \<in> Q \<Longrightarrow>
      \<exists>x. (\<exists>p\<in>P. \<exists>q\<in>Q. x = p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q) \<and> add_Tick_refusal_trace \<sigma> \<in> x"
    assume case_assms: "[Event e]\<^sub>E # \<sigma> \<in> p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q" "p \<in> P" "q \<in> Q" "TT1 P" "TT1 Q" "TT3w P" "TT3w Q"
    ...
    proof safe
      ...
      have 3: "TT3w {t. [Event e]\<^sub>E # t \<in> P}"
        by (simp add: TT3w_init_event case_assms(6))
      have 4: "q' \<in> {t. [Event e]\<^sub>E # t \<in> Q}"
        using case_assms(3) case_assms2(3) by blast
      have 5: "TT1 {t. [Event e]\<^sub>E # t \<in> Q}"
        by (simp add: TT1_init_event case_assms(5))
      have 6: "TT3w {t. [Event e]\<^sub>E # t \<in> Q}"
        by (simp add: TT3w_init_event case_assms(7))
    ...
    next
      ...
      have 2: "TT1 {t. [Event e]\<^sub>E # t \<in> Q}"
        by (simp add: TT1_init_event case_assms(5))
      have 3: "TT3w {t. [Event e]\<^sub>E # t \<in> Q}"
        by (simp add: TT3w_init_event case_assms(7))
  ...
  next
    ...
    assume ind_hyp: "\<And>p q P Q. TT1 P \<Longrightarrow> TT1 Q \<Longrightarrow> TT3w P \<Longrightarrow> TT3w Q \<Longrightarrow> \<sigma> \<in> p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q \<Longrightarrow> p \<in> P \<Longrightarrow> q \<in> Q \<Longrightarrow>
      \<exists>x. (\<exists>p\<in>P. \<exists>q\<in>Q. x = p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q) \<and> add_Tick_refusal_trace \<sigma> \<in> x"
    assume case_assms: "TT1 P" "TT1 Q" "TT3w P" "TT3w Q" "[X]\<^sub>R # [Tock]\<^sub>E # \<sigma> \<in> p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q" "p \<in> P" "q \<in> Q"
    ...
    proof (safe)
      ...
      have 3: "TT3w {t. [Y]\<^sub>R # [Tock]\<^sub>E # t \<in> P}"
        by (simp add: TT3w_TT1_init_tock case_assms(1) case_assms(3))
      ...
      have 6: "TT3w {t. [Z]\<^sub>R # [Tock]\<^sub>E # t \<in> Q}"
        by (simp add: TT3w_TT1_init_tock case_assms(2) case_assms(4))
      ...
      then have "p'' \<in> {t. [Y \<union> {Tick}]\<^sub>R # [Tock]\<^sub>E # t \<in> P} \<and> q'' \<in> {t. [Z \<union> {Tick}]\<^sub>R # [Tock]\<^sub>E # t \<in> Q} \<and> add_Tick_refusal_trace \<sigma> \<in> p'' \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q''"
        using TT3w_TT1_add_Tick_ref_Tock case_assms case_assms by auto
      then show "\<exists>x. (\<exists>p\<in>P. \<exists>q\<in>Q. x = p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q) \<and> [insert Tick X]\<^sub>R # [Tock]\<^sub>E # add_Tick_refusal_trace \<sigma> \<in> x"
    ...
    next
      ...
      have 2: "TT1 {t. [Z]\<^sub>R # [Tock]\<^sub>E # t \<in> Q}"
        by (simp add: TT1_init_tock case_assms(2))
      have 3: "TT3w {t. [Z]\<^sub>R # [Tock]\<^sub>E # t \<in> Q}"
        by (simp add: TT3w_TT1_init_tock case_assms(2) case_assms(4))
      have 4: "TT1 {[], [[Tick]\<^sub>E]}"
        using TT_Skip unfolding TT_defs SkipTT_def by simp
      have 5: "TT3w {[], [[Tick]\<^sub>E]}"
        using TT3w_Skip unfolding TT3w_def SkipTT_def by simp
      ...
      then have "add_Tick_refusal_trace \<sigma> \<in> ([[Tick]\<^sub>E] \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q''') \<and> q''' \<in> {t. [Z \<union> {Tick}]\<^sub>R # [Tock]\<^sub>E # t \<in> Q}"
        using TT3w_TT1_add_Tick_ref_Tock case_assms(2) case_assms(4) by blast
      then show "\<exists>x. (\<exists>p\<in>P. \<exists>q\<in>Q. x = p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q) \<and> [insert Tick X]\<^sub>R # [Tock]\<^sub>E # add_Tick_refusal_trace \<sigma> \<in> x"
    ...
    next
      ...
      then have "add_Tick_refusal_trace \<sigma> \<in> (p''' \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C [[Tick]\<^sub>E]) \<and> p''' \<in> {t. [Y \<union> {Tick}]\<^sub>R # [Tock]\<^sub>E # t \<in> P}"
        using TT3w_TT1_add_Tick_ref_Tock case_assms(1) case_assms(3) by blast
      then show "\<exists>x. (\<exists>p\<in>P. \<exists>q\<in>Q. x = p \<lbrakk>A\<rbrakk>\<^sup>T\<^sub>C q) \<and> [insert Tick X]\<^sub>R # [Tock]\<^sub>E # add_Tick_refusal_trace \<sigma> \<in> x"
...
lemma TT3_ParComp:
  assumes "TT P" "TT Q"
  assumes "TT3 P" "TT3 Q"
  shows "TT3 (P \<lbrakk>A\<rbrakk>\<^sub>C Q)"
  using assms by (meson TT1_ParComp TT1_TT3w_equiv_TT3 TT3w_ParComp TT_def) 
...
lemma deterministic_ParComp2_idemp:
  assumes "deterministic P" "\<forall>x\<in>P. ttWF x" "TT1 P" "TT2 P" "TT3w P"
  shows "(P \<lbrakk>UNIV\<rbrakk>\<^sub>2 P) = P"
  using assms unfolding ParComp2TT_def
proof auto
  fix p q :: "'a ttobs list"
  show "\<And> P x. deterministic P \<Longrightarrow> TT1 P \<Longrightarrow> TT2 P \<Longrightarrow> TT3w P \<Longrightarrow> x \<in> p \<lbrakk>UNIV\<rbrakk>\<^sup>T\<^sub>2 q \<Longrightarrow> p \<in> P \<Longrightarrow> q \<in> P \<Longrightarrow> x \<in> P"
  ...
  next
    fix P :: "'a ttobs list set"
    fix X A x
    assume deterministic_P: "deterministic P" and TT3w_P: "TT3w P"
    assume case_assms: "[[X]\<^sub>R] \<in> P" "[[Tick]\<^sub>E] \<in> P"
    then have "[[X \<union> {Tick}]\<^sub>R] \<in> P"
      using TT3w_P unfolding TT3w_def by force
    then have False
  ...
  next
    fix P :: "'a ttobs list set"
    fix Y \<sigma> x W A s
    assume deterministic_P: "deterministic P" and TT1_P: "TT1 P" and TT3w_P: "TT3w P"
  ...
  next
    ...
    fix \<rho> \<sigma> :: "'a ttobs list"
    fix e f x s
    assume deterministic_P: "deterministic P" and TT1_P: "TT1 P" and TT2_P: "TT2 P" and TT3w_P: "TT3w P"
    assume ind_hyp: "\<And>P x. deterministic P \<Longrightarrow> TT1 P \<Longrightarrow> TT2 P \<Longrightarrow> TT3w P \<Longrightarrow> x \<in> \<rho> \<lbrakk>UNIV\<rbrakk>\<^sup>T\<^sub>2 \<sigma> \<Longrightarrow> \<rho> \<in> P \<Longrightarrow> \<sigma> \<in> P \<Longrightarrow> x \<in> P"
    ...
    have 4: "TT3w {t. [Event f]\<^sub>E # t \<in> P}"
      by (simp add: TT3w_P TT3w_init_event)
  ...
  next
    ...
    have 4: "TT3w {t. [X \<union> Y]\<^sub>R # [Tock]\<^sub>E # t \<in> P}"
      by (simp add: TT1_P TT3w_P TT3w_TT1_init_tock)
